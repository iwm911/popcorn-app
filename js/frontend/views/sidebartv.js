var SidebarTemplate = $('#sidebar-tpl2').html();
...
App.View.Sidebar = Backbone.View.extend({
    ...
    hide: function() {
        ...
        // A user was going to watch a TV show, but he cancelled, maybe because no sub in user locale
